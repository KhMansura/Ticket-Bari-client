                    ...
                    <div class="content">
                        <div class="info-grid">
                            <div class="info-item" style="grid-column: span 2;">
                                ...
                                <span class="value" style="font-size: 18px; color: #1e3a8a;">${payment.ticketTitle}</span>
                            </div>
                            ...
                            <div class="info-item">
                                <span class="label">Passenger Name</span>
                                <span class="value">${payment.customerName || user.displayName}</span>
                            </div>
                            <div class="info-item">
                                <span class="label">Passenger Email</span>
                                <span class="value">${payment.customerEmail || user.email}</span>
                            </div>
                            <div class="info-item">
                                <span class="label">Route</span>
                                <span class="value">${payment.from || 'Dhaka'} ➝ ${payment.to || 'Destination'}</span>
