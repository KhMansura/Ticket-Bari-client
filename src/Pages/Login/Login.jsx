...
import { useContext, useState, useRef } from "react"; // Added useRef
import { Link, useLocation, useNavigate } from "react-router-dom";
import Swal from "sweetalert2";
import { AuthContext } from "../../providers/AuthProviders";
import { FaEye, FaEyeSlash, FaGoogle, FaEnvelope, FaLock } from "react-icons/fa";
import { getAuth, sendPasswordResetEmail } from "firebase/auth"; // Added imports
import { app } from "../../firebase/firebase.config"; // Added import
                        ...
                        <div className="form-control">
                            ...
                            <div className="relative">
                                ...
                                <input 
                                    type="email" 
                                    name="email" 
                                    ref={emailRef} // ✅ Connected Ref Here
                                    placeholder="Enter your email" 
                                    className="input input-bordered w-full pl-11 bg-base-200 focus:bg-white focus:border-primary transition-all rounded-lg h-12" 
                                    required
                                />
